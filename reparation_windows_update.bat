...
@echo off
if %errorlevel% == 0 (echo [40;33mla réparation est terminé [42;37m[OK][40;36m & echo nous alon restart Windows & timeout /t 5 & goto restart) else (echo [41;37m[ERREUR] [40;33mla réparation a échouer ! & echo ouverture du raport & start C:\Windows\Logs\DISM\Dism.log & pause & goto restart)
goto restart
